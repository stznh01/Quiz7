...
@interface Q7MasterViewController ()
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath;
@end

@implementation Q7MasterViewController
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.detailTextLabel.text = [NSString stringWithFormat:@"%@,(%.0f)",[df stringFromDate:[object valueForKey:@"dueDate"]],[object urgency]];
